...
class Patch:
    def __init__(self,index: int, left_x: int, right_x: int, upper_y: int, lower_y: int):
        self.index = index
        self.left_x = left_x
    ...
    def sliding_window(self, image: np.ndarray, window_size: WindowSize, stride: Stride = 0):
        """
    ...
    def extract_grids(self, dataset_path: str, ground_truth_path: str, window_size: Tuple, total_samples_count: int):
        """
        ...
        patches = self.sliding_window(input_data, window)
